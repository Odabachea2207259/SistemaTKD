...
$button = "<button id=\"ocButton\" onclick=\"dropdown()\" class=\"absolute bg-[#1C6AD5] h-[3rem] w-[calc(100%+40px)] flex place-items-end justify-end rounded-r-lg z-1 left-[0.1vw] lg:left-[3%] xl:left-[5%] transition duration-300 ease-in-out\">
                <div class=\"w-[10vw] sm:w-[2vw] md:w-[5vw] lg:w-[5vw] xl:w-[2.5vw]\">
                    <svg class=\"\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 300 300\" text-rendering=\"geometricPrecision\">
                    ...
                    <svg class=\"hidden\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 300 300\">
...
<aside id="sidebar" class="absolute left-0 h-full w-2/3 sm:w-2/3 md:w-1/4 lg:w-1/4 flex flex-row text-white transition duration-300 ease-in-out z-10">
    <div class="bg-[#1C6AD5] h-full w-[calc(100%-40px)] flex flex-col rounded-r-lg items-center z-20">
        <button id="user" class="w-full text-[1.5rem] sm:text-[1.5rem] md:text-[2rem] lg:text-[2rem] xl:text-[3rem] flex justify-between px-2 mb-20 mt-3">
