...
<body id="body" class="relative min-h-screen flex items-center justify-center font-mono bg-black bg-opacity-30 transition duration-300 ease-linear">
    ...
    <div class="absolute w-full h-full flex flex-col">
        ...
        <div id="content" class="relative flex justify-center flex-wrap w-full h-full opacity-30 transition duration-300 ease-linear">
            @yield('content')
        </div>
    </div>
